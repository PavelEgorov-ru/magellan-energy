  ...
  switch (tag) {
    case 'h1':
      return <h1 className={cn(styles.h1, {
        colorWith: [styles.h_white]
      })}> {children} </h1>;
    case 'h2':
      return <h2 className={cn(styles.h2, {[styles.h_white] : colorWith == true})}>
        {children}
        </h2>;
    case 'h3':
    ...
    case 'h5':
      return <h5 className={cn(styles.h5, {
        [styles.h_white] : colorWith == true
      })}>{children}</h5>;
    case 'h6':
      return <h6 className={cn(styles.h6, {
        [styles.h_white] : colorWith == true
      })}>{children}</h6>;
    default:
      return <></>
